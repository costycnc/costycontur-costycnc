...
;				Push Ebx
				...
				Invoke SalveazaSetari, _pCSMCompBuffer
...
;	Push Eax
	...
	Invoke SetWindowPos, Eax, HWND_TOP, 0, 0, _patrat.right, 12, SWP_NOMOVE

	Invoke GetDlgItem, _hWnd2, IDC_WINDOW2_PROGRESY
	Push Eax
	Invoke GetWindowRect, Eax, Addr patrat2
	Pop Eax
	Sub patrat2.left, 202
	Invoke SetWindowPos, Eax, HWND_TOP, patrat2.left, 20, 12, _patrat.bottom, SWP_SHOWWINDOW
	Invoke UpdateProgresMaxXYWin2
...
;@@:
	...
	.If _nGCodeStart == 1
		Invoke StrLen, _pCode
		Add _pCode, Eax
		Invoke szCatStr, _pGCode, Addr _szGCodeZBugFix2
		Add _iGCode, 8 										;GCode ZBug-fix
		Mov _nGCodeStart, 2
		;Ret
	.EndIf
